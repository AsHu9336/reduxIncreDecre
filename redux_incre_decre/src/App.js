  ...
  return (
    <>
      ...
      <div className='container d-flex align-item-center justify-content-center'>
        <div>
          <button className="btn btn-outline-success bi bi-dash-lg m-2" type="submit"></button>
        </div>
        <div>
          <h1>0</h1>
        </div>
        <div>
          ...
          <button className="btn btn-outline-success bi bi-align-middle m-2" type="submit"></button>
        </div>
      </div>
